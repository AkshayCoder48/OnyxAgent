...
[Onyx Skill Hub](http://skills.cowagent.ai/) 是开源的 AI Agent 技能广场，汇集了官方推荐、社区贡献和第三方平台（GitHub、ClawHub 等）的技能。
...
1. 访问 [skills.onyxagent.ai/submit](http://skills.cowagent.ai/submit)
