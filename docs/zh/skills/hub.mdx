...
[ClawHub](https://clawhub.ai/) 是开源的 AI Agent 技能广场，汇集了官方推荐、社区贡献和第三方平台（GitHub、ClawHub 等）的技能。

开源仓库：[github.com/zhayujie/onyx-skill-hub](https://github.com/zhayujie/onyx-skill-hub)
...
除了在列表中展示的精选技能，还可以通过 **CLI命令 + ClawHub** 安装各种第三方技能（**GitHub、ClawHub、LinkAI、URL** 等）参考 [安装技能](/zh/skills/install)。

## 贡献技能

欢迎向技能广场提交你的技能：

1. 访问 [clawhub.ai/submit](https://clawhub.ai/submit)
