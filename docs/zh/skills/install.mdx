...
OnyxAgent 支持通过统一的 `install` 命令安装来自 [ClawHub](https://clawhub.ai/)、GitHub、LinkAI 以及任意 URL 上的技能。在对话中使用 `/skill install`，在终端中使用 `onyx skill install`。

## 从ClawHub安装

访问 [clawhub.ai](https://clawhub.ai/) 浏览所有可用技能，找到想要的技能后直接安装，例如：
