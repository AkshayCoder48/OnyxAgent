...
- [ClawHub](https://clawhub.ai/)：开放的技能广场，汇集官方推荐、社区贡献和第三方技能，支持一键安装。
...
安装技能：`/skill install <名称>` 或 `onyx skill install <名称>`，支持从 ClawHub、GitHub、URL 等来源安装。
...
访问 [clawhub.ai](https://clawhub.ai/) 浏览所有可用技能，或在对话中执行：
