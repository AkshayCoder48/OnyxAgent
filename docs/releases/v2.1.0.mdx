---
title: v2.1.0
description: OnyxAgent 2.1.0 - Internationalization, new Telegram / Discord / Slack / WeChat Customer Service channels, CLI interaction upgrades, MCP protocol enhancements and new models
---

🌐 [English](https://docs.onyxagent.ai/releases/v2.1.0) | [中文](https://docs.onyxagent.ai/zh/releases/v2.1.0)
...
- **Slack Bot**: Connect a Slack bot and bring OnyxAgent into your team's workflow
...
Documentation: [Channels Overview](https://docs.onyxagent.ai/en/channels)

## 🌍 Internationalization

OnyxAgent introduces an end-to-end internationalization framework built for developers worldwide, adapting automatically based on the system language:

- **End-to-end localization**: The install flow, CLI, logs and error messages, agent system prompts and more are all localized
- **Automatic language detection**: The default `auto` mode infers the language from the system locale, or you can set `onyx_lang` explicitly in `config.json`. English and Chinese ship first, with more languages to follow
...
Documentation: [CLI Guide](https://docs.onyxagent.ai/en/cli/general)
...
Documentation: [MCP Tools](https://docs.onyxagent.ai/en/tools/mcp)
...
**Release Date**: 2026.06.01 | [Full Changelog](https://github.com/zhayujie/OnyxAgent/compare/2.0.9...2.1.0)
