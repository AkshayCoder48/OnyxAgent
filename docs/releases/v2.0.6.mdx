---
title: v2.0.6
description: OnyxAgent 2.0.6 - Knowledge Base, Deep Dream Memory Distillation, Smart Context Compression, Web Console Multi-Session and More
---

## Project Renamed to OnyxAgent

The repository has been officially renamed from `chatgpt-on-wechat` to **OnyxAgent**, evolving into a full-featured AI Agent assistant.

- New URL: [github.com/zhayujie/OnyxAgent](https://github.com/zhayujie/OnyxAgent) — GitHub auto-redirects the old URL
...
Docs: [Knowledge Base](https://docs.onyxagent.ai/en/knowledge)
...
Docs: [Deep Dream](https://docs.onyxagent.ai/en/memory/deep-dream)
...
Docs: [Short-term Memory](https://docs.onyxagent.ai/en/memory/context)
...
- **Vision optimization**: Image recognition tool prefers the primary model with automatic multi-provider fallback. Docs: [Vision Tool](https://docs.onyxagent.ai/en/tools/vision)
...
**Release Date**: 2026.04.14 | [Full Changelog](https://github.com/zhayujie/OnyxAgent/compare/2.0.5...master)
