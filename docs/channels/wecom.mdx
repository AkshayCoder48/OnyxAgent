---
title: WeCom
description: Integrate OnyxAgent into WeCom enterprise app
---

Integrate OnyxAgent into WeCom through a custom enterprise app, supporting one-on-one chat for internal employees.
