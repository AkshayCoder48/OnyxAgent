---
title: Feishu (Lark)
description: Integrate OnyxAgent into Feishu via a custom enterprise app
---

> Integrate OnyxAgent into Feishu via a custom enterprise app. Supports p2p chat and group chat (@bot), uses WebSocket long connection (no public IP needed), supports streaming typewriter replies and voice messages.
...
1. After Onyx is running, go to **Events & Callbacks** in the Feishu Developer Platform, choose **Long Connection** mode and save:
