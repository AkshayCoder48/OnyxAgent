---
title: DingTalk
description: Integrate OnyxAgent into DingTalk application
---

Integrate OnyxAgent into DingTalk by creating an intelligent robot app on the DingTalk Open Platform.
