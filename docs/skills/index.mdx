...
description: OnyxAgent skills system introduction
---
...
OnyxAgent offers multiple ways to acquire skills:

- **Onyx Skill Hub** — Browse and install community skills via `/skill list --remote`
...
1. **Workspace skills** (highest): `~/onyx/skills/`
