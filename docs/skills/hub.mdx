...
[Onyx Skill Hub](https://skills.onyxagent.ai/) is an open-source skill marketplace for AI Agents, aggregating official picks, community contributions, and third-party skills from GitHub, ClawHub, and beyond.

Source code: [github.com/zhayujie/onyx-skill-hub](https://github.com/zhayujie/onyx-skill-hub)
...
- **One-click install** — copy the install command and run it in OnyxAgent
...
1. Visit [skills.onyxagent.ai/submit](https://skills.onyxagent.ai/submit)
