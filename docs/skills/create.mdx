...
OnyxAgent includes a built-in Skill Creator that lets you quickly create, install, or update skills through natural language conversation.
...
3. Skill is saved to the workspace `~/onyx/skills/` directory
...
<Tip>
  See the [Skill Creator documentation](https://github.com/zhayujie/OnyxAgent/blob/master/skills/skill-creator/SKILL.md) for details.
</Tip>
