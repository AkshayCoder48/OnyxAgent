...
[Onyx Skill Hub](https://skills.onyxagent.ai/) は、公式推奨・コミュニティ貢献・サードパーティ（GitHub、ClawHub など）のスキルを集約した、オープンソースの AI Agent スキルマーケットプレイスです。

ソースコード: [github.com/zhayujie/onyx-skill-hub](https://github.com/zhayujie/onyx-skill-hub)
...
- **ワンクリックインストール** — インストールコマンドをコピーして OnyxAgent で実行
...
1. [skills.onyxagent.ai/submit](https://skills.onyxagent.ai/submit) にアクセス
