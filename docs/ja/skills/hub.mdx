...
[Onyx Skill Hub](http://skills.cowagent.ai/) は、公式推奨・コミュニティ貢献・サードパーティ（GitHub、ClawHub など）のスキルを集約した、オープンソースの AI Agent スキルマーケットプレイスです。
...
1. [skills.onyxagent.ai/submit](http://skills.cowagent.ai/submit) にアクセス
