---
title: Upgrade
description: How to upgrade OnyxAgent
---

## Recommended: One-line upgrade

Use `onyx update` to pull the latest code and restart the service in one step:
...
<Note>
  If the Onyx CLI is not installed, `./run.sh update` performs the same operations.
</Note>
