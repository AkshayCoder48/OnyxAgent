...
```bash
git clone https://github.com/zhayujie/OnyxAgent
cd OnyxAgent/
```
...
<Tip>
  Full configuration options are in the project [`config.py`](https://github.com/zhayujie/OnyxAgent/blob/master/config.py).
</Tip>
